...
const (
	TxType_SCR     TxType = 0
	TxType_Invalid TxType = 1
	TxType_UserTx  TxType = 2
	TxType_Reward  TxType = 3
)
...
func (Type) Descriptor() protoreflect.EnumDescriptor {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_enumTypes[2].Descriptor()
}

func (Type) Type() protoreflect.EnumType {
	return &file_data_hyperOutportBlocks_hyperOutportBlock_proto_enumTypes[2]
}
...
type TransactionPoolV2 struct {
	...
	ScheduledExecutedSCRSHashesPrevBlock       []string             `protobuf:"bytes,2,rep,name=ScheduledExecutedSCRSHashesPrevBlock,proto3" json:"ScheduledExecutedSCRSHashesPrevBlock,omitempty"`
	ScheduledExecutedInvalidTxsHashesPrevBlock []string             `protobuf:"bytes,3,rep,name=ScheduledExecutedInvalidTxsHashesPrevBlock,proto3" json:"ScheduledExecutedInvalidTxsHashesPrevBlock,omitempty"`
}
...
type TxInfoV2 struct {
	...
	Transaction *WrappedTx   `protobuf:"bytes,1,opt,name=Transaction,proto3" json:"Transaction,omitempty"`
	FeeInfo     *FeeInfo     `protobuf:"bytes,2,opt,name=FeeInfo,proto3" json:"FeeInfo,omitempty"`
	Receipt     *Receipt     `protobuf:"bytes,3,opt,name=Receipt,proto3" json:"Receipt,omitempty"`
	ResultTxs   []*WrappedTx `protobuf:"bytes,4,rep,name=ResultTxs,proto3" json:"ResultTxs,omitempty"`
...
func (x *TxInfoV2) GetTransaction() *WrappedTx {
	if x != nil {
		return x.Transaction
	}
	return nil
...
func (x *TxInfoV2) GetReceipt() *Receipt {
	if x != nil {
		return x.Receipt
	}
	return nil
...
func (x *TxInfoV2) GetResultTxs() []*WrappedTx {
	if x != nil {
		return x.ResultTxs
	}
	return nil
...
type WrappedTx struct {
	...
	RelayerAddr       []byte `protobuf:"bytes,16,opt,name=RelayerAddr,proto3" json:"RelayerAddr,omitempty"`
	RelayedValue      []byte `protobuf:"bytes,17,opt,name=RelayedValue,proto3" json:"RelayedValue,omitempty"`
	Code              []byte `protobuf:"bytes,18,opt,name=Code,proto3" json:"Code,omitempty"`
	PrevTxHash        []byte `protobuf:"bytes,19,opt,name=PrevTxHash,proto3" json:"PrevTxHash,omitempty"`
	OriginalTxHash    []byte `protobuf:"bytes,20,opt,name=OriginalTxHash,proto3" json:"OriginalTxHash,omitempty"`
	CallType          int64  `protobuf:"varint,21,opt,name=CallType,proto3" json:"CallType,omitempty"`
	CodeMetadata      []byte `protobuf:"bytes,22,opt,name=CodeMetadata,proto3" json:"CodeMetadata,omitempty"`
	ReturnMessage     []byte `protobuf:"bytes,23,opt,name=ReturnMessage,proto3" json:"ReturnMessage,omitempty"`
	OriginalSender    []byte `protobuf:"bytes,24,opt,name=OriginalSender,proto3" json:"OriginalSender,omitempty"`
	ExecutionOrder    uint32 `protobuf:"varint,25,opt,name=ExecutionOrder,proto3" json:"ExecutionOrder,omitempty"`
	Round             uint64 `protobuf:"varint,26,opt,name=Round,proto3" json:"Round,omitempty"`
	Epoch             uint32 `protobuf:"varint,27,opt,name=Epoch,proto3" json:"Epoch,omitempty"`
	TxType            TxType `protobuf:"varint,28,opt,name=TxType,proto3,enum=proto.TxType" json:"TxType,omitempty"`
}

func (x *WrappedTx) Reset() {
	*x = WrappedTx{}
	if protoimpl.UnsafeEnabled {
...
func (x *WrappedTx) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*WrappedTx) ProtoMessage() {}

func (x *WrappedTx) ProtoReflect() protoreflect.Message {
	mi := &file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use WrappedTx.ProtoReflect.Descriptor instead.
func (*WrappedTx) Descriptor() ([]byte, []int) {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDescGZIP(), []int{21}
}

func (x *WrappedTx) GetNonce() uint64 {
	if x != nil {
		return x.Nonce
	}
	return 0
...
func (x *WrappedTx) GetValue() []byte {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *WrappedTx) GetRcvAddr() []byte {
	if x != nil {
		return x.RcvAddr
	}
	return nil
...
func (x *WrappedTx) GetRcvUserName() []byte {
	if x != nil {
...
func (x *WrappedTx) GetSndAddr() []byte {
	if x != nil {
		return x.SndAddr
	}
	return nil
...
func (x *WrappedTx) GetSndUserName() []byte {
	if x != nil {
...
func (x *WrappedTx) GetGasPrice() uint64 {
	if x != nil {
		return x.GasPrice
	}
	return 0
...
func (x *WrappedTx) GetGasLimit() uint64 {
	if x != nil {
		return x.GasLimit
	}
	return 0
...
func (x *WrappedTx) GetChainID() []byte {
	if x != nil {
		return x.ChainID
	}
	return nil
...
func (x *WrappedTx) GetVersion() uint32 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *WrappedTx) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *WrappedTx) GetOptions() uint32 {
	if x != nil {
		return x.Options
	}
	return 0
...
func (x *WrappedTx) GetGuardianAddr() []byte {
	if x != nil {
...
func (x *WrappedTx) GetGuardianSignature() []byte {
	if x != nil {
...
func (x *WrappedTx) GetRelayerAddr() []byte {
	if x != nil {
...
func (x *WrappedTx) GetRelayedValue() []byte {
	if x != nil {
...
func (x *WrappedTx) GetPrevTxHash() []byte {
	if x != nil {
		return x.PrevTxHash
	}
	return nil
...
func (x *WrappedTx) GetOriginalTxHash() []byte {
	if x != nil {
...
func (x *WrappedTx) GetCallType() int64 {
	if x != nil {
		return x.CallType
	}
	return 0
...
func (x *WrappedTx) GetCodeMetadata() []byte {
	if x != nil {
...
func (x *WrappedTx) GetReturnMessage() []byte {
	if x != nil {
...
func (x *WrappedTx) GetOriginalSender() []byte {
	if x != nil {
...
func (x *WrappedTx) GetExecutionOrder() uint32 {
	if x != nil {
		return x.ExecutionOrder
	}
	return 0
...
func (x *WrappedTx) GetRound() uint64 {
	if x != nil {
		return x.Round
	}
	return 0
...
func (x *WrappedTx) GetEpoch() uint32 {
	if x != nil {
		return x.Epoch
	}
	return 0
...
func (x *WrappedTx) GetTxType() TxType {
	if x != nil {
		return x.TxType
	}
	return TxType_SCR
...
func (x *AdditionalAccountTokenData) Reset() {
	*x = AdditionalAccountTokenData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[45]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdditionalAccountTokenData) Descriptor() ([]byte, []int) {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDescGZIP(), []int{45}
}
...
func (x *AdditionalAccountData) Reset() {
	*x = AdditionalAccountData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[46]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AdditionalAccountData) Descriptor() ([]byte, []int) {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDescGZIP(), []int{46}
}
...
func (x *Receipt) Reset() {
	*x = Receipt{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[47]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Receipt) Descriptor() ([]byte, []int) {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDescGZIP(), []int{47}
}
...
func (x *BigInt) Reset() {
	*x = BigInt{}
	if protoimpl.UnsafeEnabled {
		mi := &file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[48]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*BigInt) Descriptor() ([]byte, []int) {
	return file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDescGZIP(), []int{48}
}
...
var file_data_hyperOutportBlocks_hyperOutportBlock_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x61, 0x64, 0x65, 0x72, 0x53, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x18, 0x08,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x73, 0x12, 0x64, 0x0a, 0x14, 0x53, 0x6d, 0x61, 0x72, 0x74, 0x43, 0x6f, 0x6e, 0x74, 0x72,
	0x61, 0x63, 0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x30, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63,
	...
	0x74, 0x52, 0x65, 0x73, 0x75, 0x6c, 0x74, 0x73, 0x12, 0x3d, 0x0a, 0x07, 0x52, 0x65, 0x77, 0x61,
	0x72, 0x64, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	...
	0x52, 0x65, 0x77, 0x61, 0x72, 0x64, 0x73, 0x12, 0x40, 0x0a, 0x08, 0x52, 0x65, 0x63, 0x65, 0x69,
	0x70, 0x74, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x2e, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x6f, 0x6f,
	0x6c, 0x2e, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52,
	0x08, 0x52, 0x65, 0x63, 0x65, 0x69, 0x70, 0x74, 0x73, 0x12, 0x46, 0x0a, 0x0a, 0x49, 0x6e, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x54, 0x78, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e,
	...
	0x73, 0x12, 0x22, 0x0a, 0x04, 0x4c, 0x6f, 0x67, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x0e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61, 0x52,
	...
	0x50, 0x72, 0x65, 0x76, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x1a, 0x4e, 0x0a, 0x11, 0x54, 0x72, 0x61,
	...
	0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x78, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x05,
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x1a, 0x57, 0x0a, 0x19, 0x53, 0x6d, 0x61,
	...
	,
	...
	0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x54, 0x78, 0x49, 0x6e, 0x66,
	...
	0x74, 0x69, 0x61, 0x6c, 0x50, 0x61, 0x69, 0x64, 0x46, 0x65, 0x65, 0x22, 0x90, 0x01, 0x0a, 0x06,
	0x54, 0x78, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x34, 0x0a, 0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61,
	...
	0x0b, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x28, 0x0a, 0x07,
	0x46, 0x65, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x46, 0x65, 0x65, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x07, 0x46,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x63, 0x68, 0x12, 0x14, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0c, 0x52, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x52, 0x63, 0x76, 0x41,
	0x64, 0x64, 0x72, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x52, 0x63, 0x76, 0x41, 0x64,
	0x64, 0x72, 0x22, 0xd1, 0x01, 0x0a, 0x0e, 0x41, 0x6c, 0x74, 0x65, 0x72, 0x65, 0x64, 0x41, 0x63,
	...
	,
...
var file_data_hyperOutportBlocks_hyperOutportBlock_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes = make([]protoimpl.MessageInfo, 60)
var file_data_hyperOutportBlocks_hyperOutportBlock_proto_goTypes = []interface{}{
	...
	nil,                                // 52: proto.MetaOutportBlock.AlteredAccountsEntry
	nil,                                // 53: proto.ShardOutportBlock.AlteredAccountsEntry
	nil,                                // 54: proto.ShardOutportBlockV2.AlteredAccountsEntry
	nil,                                // 55: proto.TransactionPoolV2.TransactionsEntry
	nil,                                // 56: proto.TransactionPool.TransactionsEntry
	nil,                                // 57: proto.TransactionPool.SmartContractResultsEntry
	nil,                                // 58: proto.TransactionPool.RewardsEntry
	nil,                                // 59: proto.TransactionPool.ReceiptsEntry
	nil,                                // 60: proto.TransactionPool.InvalidTxsEntry
	nil,                                // 61: proto.ValidatorsPubKeys.ShardValidatorsPubKeysEntry
	nil,                                // 62: proto.Accounts.AlteredAccountsEntry
}
var file_data_hyperOutportBlocks_hyperOutportBlock_proto_depIdxs = []int32{
	...
	52, // 6: proto.MetaOutportBlock.AlteredAccounts:type_name -> proto.MetaOutportBlock.AlteredAccountsEntry
	13, // 7: proto.ShardOutportBlock.BlockData:type_name -> proto.BlockData
	20, // 8: proto.ShardOutportBlock.TransactionPool:type_name -> proto.TransactionPool
	28, // 9: proto.ShardOutportBlock.HeaderGasConsumption:type_name -> proto.HeaderGasConsumption
	53, // 10: proto.ShardOutportBlock.AlteredAccounts:type_name -> proto.ShardOutportBlock.AlteredAccountsEntry
	13, // 11: proto.ShardOutportBlockV2.BlockData:type_name -> proto.BlockData
	8,  // 12: proto.ShardOutportBlockV2.TransactionPool:type_name -> proto.TransactionPoolV2
	28, // 13: proto.ShardOutportBlockV2.HeaderGasConsumption:type_name -> proto.HeaderGasConsumption
	54, // 14: proto.ShardOutportBlockV2.AlteredAccounts:type_name -> proto.ShardOutportBlockV2.AlteredAccountsEntry
	55, // 15: proto.TransactionPoolV2.Transactions:type_name -> proto.TransactionPoolV2.TransactionsEntry
	2,  // 16: proto.Header.BlockBodyType:type_name -> proto.Type
	11, // 17: proto.Header.MiniBlockHeaders:type_name -> proto.MiniBlockHeader
	12, // 18: proto.Header.PeerChanges:type_name -> proto.PeerChange
	15, // 19: proto.MetaHeader.ShardInfo:type_name -> proto.ShardData
	19, // 20: proto.MetaHeader.PeerInfo:type_name -> proto.PeerData
	11, // 21: proto.MetaHeader.MiniBlockHeaders:type_name -> proto.MiniBlockHeader
	16, // 22: proto.MetaHeader.EpochStart:type_name -> proto.EpochStart
	2,  // 23: proto.MiniBlockHeader.Type:type_name -> proto.Type
	9,  // 24: proto.BlockData.Header:type_name -> proto.Header
	38, // 25: proto.BlockData.Body:type_name -> proto.Body
	39, // 26: proto.BlockData.IntraShardMiniBlocks:type_name -> proto.MiniBlock
	10, // 27: proto.MetaBlockData.Header:type_name -> proto.MetaHeader
	38, // 28: proto.MetaBlockData.Body:type_name -> proto.Body
	39, // 29: proto.MetaBlockData.IntraShardMiniBlocks:type_name -> proto.MiniBlock
	11, // 30: proto.ShardData.ShardMiniBlockHeaders:type_name -> proto.MiniBlockHeader
	17, // 31: proto.EpochStart.LastFinalizedHeaders:type_name -> proto.EpochStartShardData
	18, // 32: proto.EpochStart.Economics:type_name -> proto.Economics
	11, // 33: proto.EpochStartShardData.PendingMiniBlockHeaders:type_name -> proto.MiniBlockHeader
	0,  // 34: proto.PeerData.Action:type_name -> proto.PeerAction
	56, // 35: proto.TransactionPool.Transactions:type_name -> proto.TransactionPool.TransactionsEntry
	57, // 36: proto.TransactionPool.SmartContractResults:type_name -> proto.TransactionPool.SmartContractResultsEntry
	58, // 37: proto.TransactionPool.Rewards:type_name -> proto.TransactionPool.RewardsEntry
	59, // 38: proto.TransactionPool.Receipts:type_name -> proto.TransactionPool.ReceiptsEntry
	60, // 39: proto.TransactionPool.InvalidTxs:type_name -> proto.TransactionPool.InvalidTxsEntry
	26, // 40: proto.TransactionPool.Logs:type_name -> proto.LogData
	40, // 41: proto.TxInfo.Transaction:type_name -> proto.Transaction
	21, // 42: proto.TxInfo.FeeInfo:type_name -> proto.FeeInfo
	24, // 43: proto.TxInfoV2.Transaction:type_name -> proto.WrappedTx
	21, // 44: proto.TxInfoV2.FeeInfo:type_name -> proto.FeeInfo
	50, // 45: proto.TxInfoV2.Receipt:type_name -> proto.Receipt
	24, // 46: proto.TxInfoV2.ResultTxs:type_name -> proto.WrappedTx
	42, // 47: proto.TxInfoV2.Logs:type_name -> proto.Log
	1,  // 48: proto.WrappedTx.TxType:type_name -> proto.TxType
	41, // 49: proto.SCRInfo.SmartContractResult:type_name -> proto.SmartContractResult
	21, // 50: proto.SCRInfo.FeeInfo:type_name -> proto.FeeInfo
	42, // 51: proto.LogData.Log:type_name -> proto.Log
	44, // 52: proto.RewardInfo.Reward:type_name -> proto.RewardTx
	29, // 53: proto.ValidatorsRating.ValidatorsRatingInfo:type_name -> proto.ValidatorRatingInfo
	31, // 54: proto.RoundsInfo.RoundsInfo:type_name -> proto.RoundInfo
	61, // 55: proto.ValidatorsPubKeys.ShardValidatorsPubKeys:type_name -> proto.ValidatorsPubKeys.ShardValidatorsPubKeysEntry
	62, // 56: proto.Accounts.AlteredAccounts:type_name -> proto.Accounts.AlteredAccountsEntry
	39, // 57: proto.Body.MiniBlocks:type_name -> proto.MiniBlock
	2,  // 58: proto.MiniBlock.Type:type_name -> proto.Type
	43, // 59: proto.Log.Events:type_name -> proto.Event
	46, // 60: proto.AlteredAccount.Tokens:type_name -> proto.AccountTokenData
	49, // 61: proto.AlteredAccount.AdditionalData:type_name -> proto.AdditionalAccountData
	47, // 62: proto.AccountTokenData.MetaData:type_name -> proto.TokenMetaData
	48, // 63: proto.AccountTokenData.AdditionalData:type_name -> proto.AdditionalAccountTokenData
	45, // 64: proto.MetaOutportBlock.AlteredAccountsEntry.value:type_name -> proto.AlteredAccount
	45, // 65: proto.ShardOutportBlock.AlteredAccountsEntry.value:type_name -> proto.AlteredAccount
	45, // 66: proto.ShardOutportBlockV2.AlteredAccountsEntry.value:type_name -> proto.AlteredAccount
	23, // 67: proto.TransactionPoolV2.TransactionsEntry.value:type_name -> proto.TxInfoV2
	22, // 68: proto.TransactionPool.TransactionsEntry.value:type_name -> proto.TxInfo
	25, // 69: proto.TransactionPool.SmartContractResultsEntry.value:type_name -> proto.SCRInfo
	27, // 70: proto.TransactionPool.RewardsEntry.value:type_name -> proto.RewardInfo
	50, // 71: proto.TransactionPool.ReceiptsEntry.value:type_name -> proto.Receipt
	22, // 72: proto.TransactionPool.InvalidTxsEntry.value:type_name -> proto.TxInfo
	33, // 73: proto.ValidatorsPubKeys.ShardValidatorsPubKeysEntry.value:type_name -> proto.PubKeys
	45, // 74: proto.Accounts.AlteredAccountsEntry.value:type_name -> proto.AlteredAccount
...
func file_data_hyperOutportBlocks_hyperOutportBlock_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[45].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[46].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[47].Exporter = func(v interface{}, i int) interface{} {
		...
		file_data_hyperOutportBlocks_hyperOutportBlock_proto_msgTypes[48].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BigInt); i {
			case 0:
				return &v.state
			case 1:
